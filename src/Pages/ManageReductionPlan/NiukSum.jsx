    ...
    <div>
      <div className={style.container}>
        <div className={style.card}>
          ...
          <p style={{ fontSize: "25px", fontWeight: "bolder", letterSpacing: "1px" }}> {Math.max(...temp)} kgCO2/KwH</p>
        </div>
        <div className={style.card}>
          <span>Average Carbon Emission For Scope 1 </span>
          <p style={{ fontSize: "25px", fontWeight: "bolder", letterSpacing: "1px" }}> {(Math.min(...temp) + Math.max(...temp)) / 2} kgCO2/KwH</p>
        </div>
        <div className={style.card}>
          <span>Minimum Carbon Emission For Scope 1</span>
          <p style={{ fontSize: "25px", fontWeight: "bolder", letterSpacing: "1px" }}> {Math.min(...temp)} kgCO2/KwH</p>
        </div>
      </div>
      <div className={style.container}>
        <div className={style.card}>
          ...
          {/* <p> {Math.max(...temp)} </p> */}
          <p style={{ fontSize: "25px", fontWeight: "bolder", letterSpacing: "1px" }}>6134 kgCO2/KwH</p>
        </div>
        <div className={style.card}>
          <span>Average Carbon Emission For Scope 2  </span>
          {/* <p> {(Math.min(...temp) + Math.max(...temp)) / 2} </p> */}
          <p style={{ fontSize: "25px", fontWeight: "bolder", letterSpacing: "1px" }}>3211 kgCO2/KwH</p>
        </div>
        <div className={style.card}>
          <span>Minimum Carbon Emission For Scope 2  </span>
          {/* <p> {Math.min(...temp)} </p> */}
          <p style={{ fontSize: "25px", fontWeight: "bolder", letterSpacing: "1px" }}>1631 kgCO2/KwH</p>
        </div>
      </div>
