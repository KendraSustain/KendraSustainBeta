...
const columns = [
    { title: "pollutant", field: "pollutant", sorting: false, filtering: false, headerStyle: { color: "#fff" } },
    ...
    { title: "Emission Factor", field: "emission_factor", align: "center", grouping: false },
    { title: "unit", field: "unit", align: "center", grouping: false },
    { title: "activity units", field: "activity_unit", align: "center", grouping: false },
]
...
export default function EmissionFactor() {
    ...
    const handleSubmit = async () => {
        ...
        await apiGetData.get(`/api/emissionfactor?year=${data2.year}&sector=${data2.sector}&pollutant=${data2.pollutant}`)
            .then(res => {
    ...
    const sectors = ['Energy', 'Memo', 'Industrial Processes and Other Product Use',
        'Waste', 'Agriculture']
    ...
    return (
        <div className={[styles.factor, context.close ? styles.close : ""].join(" ")}>
            ...
            <FormControl sx={{ m: 1, minWidth: 120 }}>
                <InputLabel id="demo-simple-select-helper-label">Pollutants</InputLabel>
                <Select
                    value={pollutant}
                    label="Pollutant"
                ...
                >
                    ...
                    {pollutants.map(pollutants => {
                        return (<MenuItem value={pollutants}>{pollutants}</MenuItem>)
                    })}
                </Select>
                <FormHelperText>Select Pollutants</FormHelperText>
            </FormControl>
            <Button className={classes.root} variant="outlined" onClick={handleSubmit} sx={{ m: 1, minWidth: 120 }} style={{ marginTop: "20px" }} >Submit</Button>
